...
- Access the Data Hub: Goto the environment that is shared by the INSTRUCTOR (Ex: `pse-workshop`). +
image:images/step/ +

- Click on the DataHub associated with Streams Messaging Manager. +

- Go to the Streams Messaging Interface. +

- Select Brokers from the left tab. +

- Save the broker list. +
