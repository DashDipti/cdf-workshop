...
This lab will have a recording in the future and can be accessed by clicking - https://youtu.be/JYGoIecaPVQ[CDF-Recording]. +
...
https://docs.cloudera.com/dataflow/cloud/index.html[Cloudera Public Cloud DataFlow]
