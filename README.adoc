...
Also, after a while you will see the the flow something like below for the flow you just deployed. +
...
Create a new project: Create a SQL Stream Builer (SSB) Project by clicking `New Project` using the following details. +
